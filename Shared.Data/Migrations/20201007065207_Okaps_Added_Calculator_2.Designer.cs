...
namespace Agro.Shared.Data.Migrations
{
    ...
    [Migration("20201007065207_Okaps_Added_Calculator_2")]
    partial class Okaps_Added_Calculator_2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.Calculator", b =>
                {
                    ...
                    b.Property<Guid?>("RatePartId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("SofinancPartId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("RatePartId");

                    b.HasIndex("SofinancPartId");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.PeriodPart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("PeriodPart");
                });

            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.RatePart", b =>
                {
                    b.Property<Guid?>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.SofinancPart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.Calculator", b =>
                {
                    b.HasOne("Agro.Shared.Data.Context.Dictionary.PeriodPart", "PeriodPart")
                        .WithMany()
                        .HasForeignKey("PeriodPartId");

                    b.HasOne("Agro.Shared.Data.Context.Dictionary.RatePart", "RatePart")
                        .WithMany()
                        .HasForeignKey("RatePartId");

                    b.HasOne("Agro.Shared.Data.Context.Dictionary.SofinancPart", "SofinancPart")
                        .WithMany()
                        .HasForeignKey("SofinancPartId");
                });
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.DicLoanProduct", b =>
                {
                    b.HasOne("Agro.Shared.Data.Context.Dictionary.DicLoanType", null)
