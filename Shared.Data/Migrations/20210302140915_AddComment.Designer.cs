...
namespace Agro.Shared.Data.Migrations
{
    ...
    [Migration("20210302140915_AddComment")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.AccessTechCalculator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid?>("SelectedAccessoryTechId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("Sofinanc")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("SelectedAccessoryTechId")
                        .IsUnique()
                        .HasFilter("[SelectedAccessoryTechId] IS NOT NULL");

                    b.ToTable("AccessTechCalculators");
                });
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.BasePledge", b =>
                {
                    ...
                    b.Property<Guid?>("DicNokId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<decimal?>("ExpertSum")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal?>("ExpertiseSum")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.Dictionary.Calculator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.FloraActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.LandActivity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.MainTechCalculator", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("SelectedMainTechId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SelectedMainTechId")
                        .IsUnique()
                        .HasFilter("[SelectedMainTechId] IS NOT NULL");

                    b.ToTable("MainTechCalculators");
                });

            modelBuilder.Entity("Agro.Shared.Data.Context.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.NotificationTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.RoleStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.SelectedAccessoryTech", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("parentPrice")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("parentTechSubType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("parentTechType")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("SelectedAccessoryTeches");
                });

            modelBuilder.Entity("Agro.Shared.Data.Context.SelectedMainTech", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("subTechType")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("subTechTypeCode")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Entities.System.EntityType", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("b43d07c7-94ac-493d-b6ed-feda78f5b8e0"),
                        ...
                        new
                        {
                            Id = new Guid("ae8a4ae0-8282-4fd6-bf6e-61fbad25cc66"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("3900f4cb-5a52-45cb-8475-e6a37e2dcd51"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("db51e56e-afdf-49ec-a892-452178086be2"),
                            CreatedDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.AccessTechCalculator", b =>
                {
                    b.HasOne("Agro.Shared.Data.Context.SelectedAccessoryTech", "SelectedAccessoryTech")
                        .WithOne("AccessTechCalculators")
                        .HasForeignKey("Agro.Shared.Data.Context.AccessTechCalculator", "SelectedAccessoryTechId");
                });
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.BasePledge", b =>
                {
                    ...
                    b.HasOne("Agro.Shared.Data.Context.Dictionary.DicNok", "DicNok")
                        .WithMany()
                        .HasForeignKey("DicNokId");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.JuristResult", b =>
                {
                    ...
                    b.HasOne("Agro.Shared.Data.Context.AgroFile", "FixFile")
                        .WithMany()
                        .HasForeignKey("FixFileId");
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.LoanCondition", b =>
                {
                    ...
                    b.HasOne("Agro.Shared.Data.Context.Plan", "Plan")
                        .WithMany()
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.MainTechCalculator", b =>
                {
                    b.HasOne("Agro.Shared.Data.Context.SelectedMainTech", "SelectedMainTech")
                        .WithOne("MainTechCalculators")
                        .HasForeignKey("Agro.Shared.Data.Context.MainTechCalculator", "SelectedMainTechId");
                });
            ...
            modelBuilder.Entity("Agro.Shared.Data.Context.SelectedAccessoryTech", b =>
                {
                    b.HasOne("Agro.Shared.Data.Context.Contract", null)
                        .WithMany("SelectedAccessoryTeches")
                        .HasForeignKey("ContractId");
                });
