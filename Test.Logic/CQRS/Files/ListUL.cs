...
namespace Agro.Okaps.Logic.CQRS.Files
{
    public class ListUL
    {
        public class ListULQuery : IRequest<Response<List<FileDto>>>
        {
            public Guid LoanApplicationId { get; set; }
        }

        public class QueryHandler : IRequestHandler<ListULQuery, Response<List<FileDto>>>
        {
            private const string _rootFolderName = "wwwroot";
            private const string _docsFolderName = "docs";
            private const string _destinationFolderName = "ul";
            ...
            public async Task<Response<List<FileDto>>> Handle(ListULQuery request, CancellationToken cancellationToken)
            {
